 ...
 */
public final class MessagesCommandCompute {
    /** Base name of resource bundle for the messages. */
    private final static String MESSAGES_COMMAND_COMPUTE = "MessagesCommandCompute";
    ...
    private static Message.Builder newMessage() {
        return new Message.Builder().setBundle(MESSAGES_COMMAND_COMPUTE);
    }

    /**
     * Private constructor to prevent instantiation of this class.
     */
    private MessagesCommandCompute() {
    }
}
