...
/**
 * Observation for a PRISM file; copy of Command.
 * 
 * @author Andrea Turrini
 */
public final class Observation {
    /** label of observation. use empty string if not synchronised, not null */
    private final Expression label;
    /** Guard of the observation. */
    private final Expression guard;
    /** The different stochastically chosen alternatives of the observation. */
    private final ArrayList<Alternative> alternatives = new ArrayList<>();
    /** Source file position information about the guarded observation. */
    private final Positional positional;
    /** Player controlling the guarded observation. */
    private int player = -1;

    public Observation(Expression label, Expression guard, List<Alternative> alternatives, Positional positional) {
        assert label != null;
        assert guard != null;
